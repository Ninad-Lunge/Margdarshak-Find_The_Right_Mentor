...
const MenteeProfile = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            {/* Header */}
            <div className="shadow bg-gradient-to-r from-blue-600 to-blue-800">
                <div className="max-w-7xl mx-auto px-4 py-6">

                    <div className='flex justify-between'>
                        <button
                            onClick={() => navigate(-1)}
                            className="flex items-center text-white hover:text-gray-50 mb-4"
                        >
                        ...
                        <button
                            onClick={() => navigate(`/mentee/${menteeId}/edit`)}
                            className="text-white hover:text-black border border-white py-1 px-2 rounded-md hover:bg-white"
                        >
                            Edit Profile
                        </button>
                    </div>
                                    ...
                                    {sessions.map((session) => (
                                        ...
                                        >
                                            <div className="flex justify-between items-start">
                                                ...
                                                <span
                                                    className={`px-3 py-1 rounded-full text-sm ${session.status === 'completed'
